...
def calculate_symbolic_representation_dynamic_system2(xdown, xup, ydown, yup, h, leng, G, s_list, pt):
    cou = 1
    xtmp = xdown
    ytmp = yup
    xckl = xdown
...
for gh in range(1, (iterc+1)):
    ...
    if gh >7:
        G = calculate_symbolic_representation_dynamic_system2(x0, x1, y0, y1, h, lengx, G, list_good_dots, pointcounter)
