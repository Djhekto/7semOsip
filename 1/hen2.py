...
#--------------------------------------------------------------------------
        ...
        self.accvalue = QLineEdit( "0.5" )
        self.preaccvalue = QLineEdit( "1" )
        self.iterp = QLineEdit( "1000" )
...
#===========================================================================================
    ...
    def start1(self):
        ...
        for i in range(itercount-1):
            ...
            X_current = self.fun1.text().replace(str(x), enc(str(V1_x_folder[-1] )) )
            X_current = X_current.replace(str(y), enc(str(V1_y_folder[-1]) ) )
            X_current = X_current.replace(str(a_s), str(a) )
            X_current = X_current.replace(str(b_s), str(b) )
            X_current = eval(X_current)
