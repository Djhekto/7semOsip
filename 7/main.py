...
#--------------------------------------------------------------------------
        ...
        self.group1 = QGroupBox("Дополнительные настройки")
        self.group1.setMaximumSize(300, 200) 
        layout1 = QGridLayout()
        self.labelextra= QLabel("Поделить высоту столбца на размер ячейки ")
        layout1.addWidget(self.labelextra,0,0)
        self.checkboxextra = QCheckBox()
        layout1.addWidget(self.checkboxextra,0,1)
        self.extradefault = False
        self.checkboxextra.stateChanged.connect(self.extraaction)
        self.group1.setLayout(layout1)        
