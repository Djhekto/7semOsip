            ...
            if (!used[v1]) {
                ...
                if ((component.size()>1) || flag==1)
                {
                    ...
                    if (it==iterations)
                    {
                        ...
                        map<long long, long long> Stv; //������� ������
                        for (vector<long long>::iterator itv = component.begin(); itv!=component.end(); itv++) //������� ���
                        {
                            ...
                            for (vector<long long>::iterator itmz=Mz.begin();itmz!=Mz.end(); itmz++) //�������� �� M* � ����� ����
                            {
                                if (*itmz==to)
                                {
                                    Mz.erase(itmz);
                        ...
                        for (map<long long, long long>::iterator itm=Nz.begin(); itm!=Nz.end();itm++)
                        {
                            ...
                            if ((flag==0) || ((sumosn/csize)<bestminscore))
                            {
                                bestminscore=(sumosn/csize);
                                initmincycle.clear();
                                initmincycle=curcycle;
                            }
                            if ((flag==0) || ((sumosn/csize)>bestmaxscore))
                            {
                        ...
                        while(TRUE)
                        {
                            ...
                            deque<long long> M1;
                            set<long long> M2;
                            for (vector<long long>::iterator itv = component.begin(); itv!=component.end(); itv++) //���������� M2
                            {
                                M2.insert(*itv);
                            }
                        ...
                        fout<<bestminscore<<" ; "<<bestmaxscore<<endl;
